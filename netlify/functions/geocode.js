...
//                             VIKTIGT: nyckeln får INTE ha HTTP-referrer-
//                             restriktion (server-side-anrop skickar ingen
//                             Referer-header → Google avvisar med
//                             "API keys with referer restrictions cannot
//                             be used with this API"). Använd istället
//                             "API restrictions" → endast Geocoding API.
//   SUPABASE_URL
//   SUPABASE_ANON_KEY
// ============================================================
